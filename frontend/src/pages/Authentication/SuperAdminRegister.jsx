...
import { addUser, superAdminSignup } from '../../actions/userActions';
import { centersList } from '../../actions/centerActions';
import Modal from '../../components/Modal';
import { ADD_USER_RESET } from '../../store/auth/login/actionTypes';

// console.log(NaijaStates);

const SuperAdminRegister = ({ history }) => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(superAdminSignup(userDetails));
    dispatch({
      type: ADD_USER_RESET,
    });
  };
  ...
  return (
    <>
      ...
      <div className='page-content'>
        <Breadcrumbs title='Users' breadcrumbItem='Super-Admin' />
