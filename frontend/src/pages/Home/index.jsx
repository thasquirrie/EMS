...
const metrics = [
  ...
  },
  {
    id: 2,
    stat: '25K+',
    emphasis: 'States around the Nigeria',
...
const footerNavigation = {
  ...
  social: [
    ...
    {
      name: 'Instagram',
      to: 'https://www.instagram/thadonzulu',
      icon: (props) => (
        <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
          <path
            fillRule='evenodd'
        ...
        <Popover className='relative bg-white'>
          <div className='flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8'>
            <div className='flex justify-start lg:w-0 lg:flex-1'>
              <Link to={'/'}>
                ...
                <img
                  ...
                  src='https://tailwindui.com/img/logos/workflow-mark-blue-600-to-blue-600.svg'
                  alt=''
                />
              </Link>
            </div>
                        ...
                        <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden'>
                          <div className='relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2'>
                            {solutions.map((item) => (
                              ...
                              >
                                <div className='flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-gradient-to-r from-blue-600 to-blue-600 text-white sm:h-12 sm:w-12'>
                                  <item.icon
                                    className='h-6 w-6'
                                    aria-hidden='true'
                                  />
            ...
            <div className='hidden md:flex items-center justify-end md:flex-1 lg:w-0'>
              ...
              <Link
                to={'/register'}
                className='ml-8 whitespace-nowrap inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-blue-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:from-blue-700 hover:to-blue-700'
              >
                Sign up
              </Link>
            </div>
              ...
              <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50'>
                  ...
                  <div className='mt-6'>
                    <nav className='grid grid-cols-1 gap-7'>
                      {/* {solutions.map((item) => (
                        ...
                        >
                          <div className='flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-gradient-to-r from-blue-600 to-blue-600 text-white'>
                ...
                <div className='py-6 px-5'>
                  ...
                  <div className='mt-6'>
                    <Link
                      to={'/register'}
                      className='w-full flex items-center justify-center bg-gradient-to-r from-blue-600 to-blue-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:from-blue-700 hover:to-blue-700'
                    >
                      Sign up
                    </Link>
                ...
                <div>
                  ...
                  <div className='mt-6'>
                    ...
                    <div className='mt-6'>
                      <Link
                        to={'/'}
                        className='inline-flex bg-gradient-to-r from-blue-600 to-blue-600 bg-origin-border px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-blue-700 hover:to-blue-700'
                      >
                        Get started
                      </Link>
                    </div>
              ...
              <div className='mt-12 sm:mt-16 lg:mt-0'>
                <div className='pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full'>
                  <img
                    ...
                    src='https://tailwindui.com/img/component-images/inbox-app-screenshot-.jpg'
        ...
        <div className='max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8'>
            ...
            <div className='mt-12 xl:mt-0'>
              ...
              <form className='mt-4 sm:flex sm:max-w-md'>
                ...
                <div className='mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0'>
                  <button
                    type='submit'
                    className='w-full flex items-center justify-center bg-gradient-to-r from-blue-600 to-blue-600 bg-origin-border px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-blue-700 hover:to-blue-700'
                  >
                    Subscribe
                  </button>
                </div>
          ...
          <div className='mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16'>
            ...
            <p className='mt-8 text-base text-gray-400 md:mt-0 md:order-1'>
              &copy; 2021 SquirrieLabs, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
