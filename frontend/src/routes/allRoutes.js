...
import Enrollees from '../pages/Enrollees/index';
...
import AddEnrollee from '../pages/Enrollees/addEnrollee';
...
const userRoutes = [
  ...
  { path: '/:id/dashboard', component: Dashboard2 },
  { path: '/calendar', component: Calendar },
  { path: '/users', component: Users },
  { path: '/add-user', component: AddUser },
  { path: '/enrollees', component: Enrollees },
  { path: '/add-enrollee', component: AddEnrollee },
  { path: '/enrollees/:id', component: EnrolleeDetails },
...
const homeRoute = { path: '/', exact: true, component: Home };

export { userRoutes, authRoutes, homeRoute };
