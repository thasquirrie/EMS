      ...
      <SimpleBar ref={ref} className='vertical-simplebar'>
        <div id='sidebar-menu'>
          <ul className='metismenu list-unstyled' id='side-menu'>
            ...
            {props.user && props.user.user.role !== 'user' && (
              <li>
            ...
            <li>
              <Link to='/enrollees' className=' waves-effect'>
                <i className='mdi mdi-office-building'></i>
                <span>{props.t('Enrollees')}</span>
              </Link>
            </li>
            {props.user && props.user.user.role !== 'user' && (
              <li>
                <Link to='/centers' className=' waves-effect'>
            ...
            {/* {props.user
              ? props.user.user.role === 'super-admin' && (
                  <>
                    <li>
